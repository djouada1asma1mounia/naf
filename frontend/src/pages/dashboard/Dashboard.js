...
import {
  Grid, Card, CardContent, Typography, Box, Skeleton, Divider,
  List, ListItem, ListItemText, ListItemAvatar, Avatar, Chip, Button, LinearProgress, useTheme,
} from '@mui/material';
import {
        ...
        <>
          <Grid container spacing={2.5} mb={3}>
            <Grid item xs={12} sm={6} lg={3}>
              <StatCard
                ...
                subtitle={`${stats.activeMaterials} actifs`}
                icon={<ComputerIcon />}
                color="primary"
              />
            </Grid>
                  ...
                  {(() => {
                    ...
                    return (
                      <Box display="flex" flexDirection="column" gap={2.5}>
                        ...
                        <Box mt={0.5} pt={1.5} sx={{ borderTop: 1, borderColor: 'divider' }}>
          ...
          <Grid container spacing={2.5}>
                ...
                <CardContent sx={{ height: '100%', pb: '16px !important' }}>
                  ...
                  <ResponsiveContainer width="100%" height="85%">
                    ...
                    >
                      ...
                      <YAxis dataKey="name" type="category" tick={{ fontSize: 11, fill: theme.palette.text.secondary }} width={80} />
                      <Tooltip
                        contentStyle={{
                          backgroundColor: theme.palette.background.paper,
                          border: `1px solid ${theme.palette.divider}`,
                      ...
                      />
                      <Bar dataKey="value" name="Matériels" fill={theme.palette.primary.main} radius={[0, 4, 4, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} md={7}>
              <Card sx={{ height: 300 }}>
                <CardContent sx={{ height: '100%', overflow: 'auto', pb: '16px !important' }}>
        ...
        <Box>
          <Grid container spacing={2.5} mb={3}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <StatCard
                title="Actifs"
                value={myMaterials.filter((m) => m.status === 'Actif').length}
            ...
            <Grid item xs={12} sm={6} md={4}>
              <StatCard
                title="En Maintenance"
                value={myMaterials.filter((m) => m.status === 'En Maintenance').length}
                      ...
                      >
                        <Box display="flex" justifyContent="space-between" alignItems="flex-start">
                          ...
                          <Chip
                            label={mat.status}
                            size="small"
                            color={mat.status === 'Actif' ? 'success' : 'warning'}
