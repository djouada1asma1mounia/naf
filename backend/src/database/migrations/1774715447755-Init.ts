...
export class Init1774715447755 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`materiels\` (\`numeroSerie\` varchar(255) NOT NULL, \`dateEntree\` date NULL, \`etat\` enum ('En Service', 'En Panne', 'Reforme') NOT NULL, \`marque\` varchar(255) NULL, \`modele\` varchar(255) NULL, \`categorieId\` int NOT NULL, \`departmentId\` int NOT NULL, \`proprietaireId\` varchar(36) NOT NULL, PRIMARY KEY (\`numeroSerie\`)) ENGINE=InnoDB`);
